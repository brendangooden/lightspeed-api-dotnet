...
namespace LightSpeed.Api.Client.Reporting
{
    public static class ReportingApiHelper
    {
        ...
        /// <returns></returns>
        public static async Task<IReadOnlyList<ReportSummaryData>> GetListAsync(IRestApiConfiguration apiConfiguration, DateTime dateFrom, DateTime dateTo, GroupBy groupBy)
        {
